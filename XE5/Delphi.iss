;{ *********************************************************************** }
;{                                                                         }
;{   Embarcadero Delphi XE5 Lite 安装脚本                                  }
;{                                                                         }
...
#define AppBinVersion   GetFileVersion("Files\Embarcadero\RAD Studio\12.0\bin\bds.exe")
#define AppLiteVersion  "8.2"
#define AppFileNamePrex "Embarcadero.Delphi.XE5.RTM.Inc.Update2"
#define AppNamePrex     "Embarcadero Delphi XE5 Lite"

#define AppSetupID      "{500B2E57-BECC-45E4-8603-523609983623}"
#define AppSetupMutex   "{50AA5C08-FBA1-47AC-9A59-B6477036AE5F}"
...
DefaultDirName={pf32}\Embarcadero\RAD Studio\12.0
DefaultGroupName=Embarcadero RAD Studio XE5
...
UninstallDisplayName=Embarcadero RAD Studio XE5
...
LicenseFile=Files\Embarcadero\RAD Studio\12.0\license_en.rtf
...
Name: CORE\HOTFIX; Description: Hotfix 1-6 Files; Types: FULL LITE CUSTOM; ExtraDiskSpaceRequired: 18828888
Name: CORE\PATCH; Description: Unis's Keymaker v1.0; Types: FULL LITE CUSTOM
...
Name: PLATFORM\X64; Description: 64 Bit Compiler; Types: LITE FULL; ExtraDiskSpaceRequired: 1048879073
Name: PLATFORM\OSX; Description: OS X Cross Platform Development; Types: LITE FULL; ExtraDiskSpaceRequired: 534361036

Name: MOBILE; Description: Mobile Features; Types: LITE FULL
Name: MOBILE\ANDSDK; Description: Android Development SDK/NDK; Types: LITE FULL; ExtraDiskSpaceRequired: 1585384600
Name: MOBILE\ANDROID; Description: Android Development Platform; Types: LITE FULL; ExtraDiskSpaceRequired: 2816406037
Name: MOBILE\IOS; Description: iOS Development Platform; Types: LITE FULL; ExtraDiskSpaceRequired: 2550110634
...
Name: EXTRA\PASERVER; Description: Platform Assistant; Types: FULL; ExtraDiskSpaceRequired: 68049695
Name: EXTRA\SAMPLE; Description: Samples; Types: FULL; ExtraDiskSpaceRequired: 637068154
Name: EXTRA\SHARE; Description: Share Files; Types: FULL; ExtraDiskSpaceRequired: 25733015
Name: EXTRA\3TH; Description: 3th Files; Types: FULL; ExtraDiskSpaceRequired: 16022646
...
Name: ADDONS\DOCINSI; Description: Documentation Insight; Types: FULL; ExtraDiskSpaceRequired: 3582411
Name: ADDONS\FASTREPORT; Description: FastReport; Types: FULL; ExtraDiskSpaceRequired: 96156667
...
[InstallDelete]
Type: files; Name: {app}\install_en.html
...
Name: {userappdata}\Embarcadero\BDS\12.0
...
;Main
#ifndef DEBUGMODE
Source: Files\Embarcadero\RAD Studio\12.0\*; DestDir: {app}; Flags: recursesubdirs ignoreversion createallsubdirs sortfilesbyextension
#endif
#ifdef  DEBUGMODE
Source: Files\Embarcadero\RAD Studio\12.0.DEBUG\*; DestDir: {app}; Flags: recursesubdirs ignoreversion createallsubdirs sortfilesbyextension
#endif
...
;WelcomePage
Source: Others\WelcomePage\*; DestDir: {userappdata}\Embarcadero\BDS\12.0; Flags: ignoreversion sortfilesbyextension
;Ico
...
Source: Others\Ext\*; DestDir: {app}; Flags: onlyifdoesntexist; AfterInstall: ExtractFileInstall('Ext.PAServer.7z')
Source: Others\Ext\*; DestDir: {app}; Flags: onlyifdoesntexist; AfterInstall: ExtractFileInstall('Ext.Samples.7z')
Source: Others\Ext\*; DestDir: {app}; Flags: onlyifdoesntexist; AfterInstall: ExtractFileInstall('Ext.Share.7z')
Source: Others\Ext\*; DestDir: {app}; Flags: onlyifdoesntexist; AfterInstall: ExtractFileInstall('Ext.3th.7z')
Source: Others\Ext\*; DestDir: {app}; Flags: onlyifdoesntexist; AfterInstall: ExtractFileInstall('Ext.HotFix.7z')
...
Name: {group}\Delphi XE5; Filename: {app}\bin\bds.exe; WorkingDir: {app}\bin; Parameters: -pDelphi; Comment: This will run the Delphi XE5 Program
;Name: {group}\Embarcadero RAD Studio XE5; Filename: {app}\bin\bds.exe; WorkingDir: {app}\bin; Comment: This will run the Embarcadero RAD Studio XE5 Program
...
Name: {userdesktop}\Delphi XE5; Filename: {app}\bin\bds.exe; WorkingDir: {app}\bin; Parameters: -pDelphi; Comment: This will run the Delphi XE5 Program

Name: {userappdata}\Microsoft\Internet Explorer\Quick Launch\Delphi XE5; Filename: {app}\bin\bds.exe; Parameters: -pDelphi; Tasks: QUICK; OnlyBelowVersion: 5.0,6.1
...
Filename: {app}\Keygen\Activator.exe; WorkingDir: {app}\Keygen; Parameters: -process; StatusMsg: {cm:StatusRunning,Embarcadero Delphi XE5 Activator}; Flags: runminimized; Components: CORE\PATCH
...
Filename: {sys}\cmd.exe; WorkingDir: {code:GetAdtDir}\sdk\tools\; Parameters: "/c echo no | android.bat -s create avd -n rsxe5_android -t 1 -f"; StatusMsg: {cm:StatusRunning,Create AVD...}; Flags: runminimized; Components: MOBILE\ANDROID

;Filename: {sys}\cmd.exe; WorkingDir: {code:GetAdtDir}\sdk\tools\; Parameters: "/c emulator.exe -avd  rsxe5_android -gpu on -no-window"; StatusMsg: {cm:StatusRunning,Config AVD...}; Flags: runminimized; Components: MOBILE\ANDROID

Filename: {src}\FastReport4VCL.exe; WorkingDir: {src}; Parameters: "/S /var:InstallPath=""{pf32}\FastReports"""; StatusMsg: {cm:StatusInstalling,FastReport}; Flags: skipifdoesntexist; Components: ADDONS\FASTREPORT
Filename: {src}\DevJET_DI_Setup_Express.exe; WorkingDir: {src}; Parameters: "/VERYSILENT /DIR=""{pf32}\DevJet"""; StatusMsg: {cm:StatusInstalling,Documentation Insight}; Flags: skipifdoesntexist; Components: ADDONS\DOCINSI
...
Filename: {app}\bin\bds.exe; WorkingDir: {app}\bin; Parameters: -pDelphi; Description: {cm:LaunchProgram,Embarcadero Delphi XE5}; Flags: nowait postinstall
...
Root: HKLM; SubKey: SOFTWARE\Classes\Applications\bdsLauncher.exe\shell\open; ValueType: string; ValueName: FriendlyName; ValueData: Embarcadero RAD Studio XE5
...
Root: HKLM; SubKey: SOFTWARE\Classes\BDS.BDSDEPLOYFile\DefaultIcon; ValueType: string; ValueName: ; ValueData: """{app}\Bin\deployide190.bpl"",0"; Components: ASSOC\BDSDEPLOY
...
Root: HKLM; SubKey: SOFTWARE\Classes\BDS.ConfigFile\DefaultIcon; ValueType: string; ValueName: ; ValueData: """{app}\Bin\dotnetaspide190.bpl"",6"; Components: ASSOC\CONFIG
...
Root: HKLM; SubKey: SOFTWARE\Classes\BDS.DfmFile\DefaultIcon; ValueType: string; ValueName: ; ValueData: """{app}\Bin\delphicoreide190.bpl"",1"; Components: ASSOC\DFM
...
Root: HKLM; SubKey: SOFTWARE\Classes\BDS.DpkFile\DefaultIcon; ValueType: string; ValueName: ; ValueData: """{app}\Bin\delphicoreide190.bpl"",2"; Components: ASSOC\DPK
...
Root: HKLM; SubKey: SOFTWARE\Classes\BDS.DpkwFile\DefaultIcon; ValueType: string; ValueName: ; ValueData: """{app}\Bin\delphicoreide190.bpl"",2"; Components: ASSOC\DPKW
...
Root: HKLM; SubKey: SOFTWARE\Classes\BDS.DprFile\DefaultIcon; ValueType: string; ValueName: ; ValueData: """{app}\Bin\delphicoreide190.bpl"",3"; Components: ASSOC\DPR
...
Root: HKLM; SubKey: SOFTWARE\Classes\BDS.DProjFile\DefaultIcon; ValueType: string; ValueName: ; ValueData: """{app}\Bin\delphicoreide190.bpl"",3"; Components: ASSOC\DPROJ
...
Root: HKLM; SubKey: SOFTWARE\Classes\BDS.FmxFile\DefaultIcon; ValueType: string; ValueName: ; ValueData: """{app}\Bin\delphicoreide190.bpl"",4"; Components: ASSOC\FMX
...
Root: HKLM; SubKey: SOFTWARE\Classes\BDS.PasFile\DefaultIcon; ValueType: string; ValueName: ; ValueData: """{app}\Bin\delphicoreide190.bpl"",6"; Components: ASSOC\PAS
...
Root: HKLM; SubKey: SOFTWARE\Embarcadero; ValueType: string; ValueName: ; ValueData: 

Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0; ValueType: string; ValueName: AndroidPath; ValueData: {code:GetAdtDir}\sdk; Components: MOBILE\ANDROID
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0; ValueType: string; ValueName: App; ValueData: {app}\bin\bds.exe
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0; ValueType: string; ValueName: Compatible; ValueData: 43494
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0; ValueType: string; ValueName: Edition; ValueData: Architect
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0; ValueType: string; ValueName: InstallLanguage; ValueData: English
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0; ValueType: string; ValueName: ProductVersion; ValueData: 19
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0; ValueType: string; ValueName: RegCompany; ValueData: {computername}
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0; ValueType: string; ValueName: RegMergeTimeStamp; ValueData: 4-4-2014 04|04|04
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0; ValueType: string; ValueName: RegOwner; ValueData: {username}
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0; ValueType: string; ValueName: RootDir; ValueData: {app}\
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0; ValueType: string; ValueName: UseSharedFiles; ValueData: TRUE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ActiveX Controls; ValueType: string; ValueName: PalettePage; ValueData: ActiveX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ActiveX Controls; ValueType: string; ValueName: UnitDirName; ValueData: $(BDSUSERDIR)\Imports
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\C++\Paths\OSX32; ValueType: string; ValueName: BPIOutput; ValueData: $(BDSCOMMONDIR)\DCP\OSX32; Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\C++\Paths\OSX32; ValueType: string; ValueName: BPLOutput; ValueData: $(BDSCOMMONDIR)\BPL\OSX32; Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\C++\Paths\OSX32; ValueType: string; ValueName: IncludePath; ValueData: "$(BDSINCLUDE);$(BDSINCLUDE)\dinkumware;$(BDSINCLUDE)\osx\crtl;$(BDSINCLUDE)\osx\rtl"; Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\C++\Paths\OSX32; ValueType: string; ValueName: LibraryPath; ValueData: "$(BDSLIB)\osx32\release;$(BDS)\Redist\OSX32"; Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\DBExpress; ValueType: string; ValueName: Connection Registry File; ValueData: {commondocs}\RAD Studio\dbExpress\12.0\dbxconnections.ini
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\DBExpress; ValueType: string; ValueName: DLLPATH; ValueData: {commondocs}\RAD Studio\dbExpress\12.0
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\DBExpress; ValueType: string; ValueName: Driver Registry File; ValueData: {commondocs}\RAD Studio\dbExpress\12.0\dbxdrivers.ini
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Debugging\Embarcadero Debuggers\Evaluators; ValueType: string; ValueName: ; ValueData: dcc32190.dll
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Debugging\Embarcadero Debuggers\Evaluators; ValueType: string; ValueName: dcc32190.dll; ValueData: 0
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Debugging\Embarcadero Debuggers\Language Exception Classes; ValueType: string; ValueName: EJNIException; ValueData: 1
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Disabled Packages; ValueType: string; ValueName: $(BDS)\bin\dcloffice2k190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Disabled Packages; ValueType: string; ValueName: $(BDS)\bin\dclofficexp190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\DotNetFramework; ValueType: string; ValueName: AssemblyLinker; ValueData: {win}\Microsoft.NET\Framework\v2.0.50727\al.exe
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Environment Variables; ValueType: string; ValueName: DEMOSDIR; ValueData: {app}\Samples\
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Environment Variables; ValueType: string; ValueName: IB_Protocol; ValueData: gds_db; Components: ADDONS\INTERBASE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Environment Variables; ValueType: string; ValueName: IBREDISTDIR; ValueData: {commondocs}\InterBase\redist\InterBaseXE3
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Environment Variables; ValueType: string; ValueName: InterBase; ValueData: {app}\InterBaseXE3
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Environment Variables; ValueType: string; ValueName: Path; ValueData: "{commondocs}\InterBase\redist\InterBaseXE3\win32_togo;{commondocs}\InterBase\redist\InterBaseXE3\win64_togo;$(PATH)"
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Experts; ValueType: string; ValueName: Beyond Compare IDE Package; ValueData: $(BDS)\Bin\Scooter.BeyondCompare.Expert.dll
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Globals; ValueType: string; ValueName: AlwaysCheckPathOnStartup; ValueData: 0; Check: not IsTaskSelected('ENVBPL')
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Globals; ValueType: string; ValueName: InstalledDemosDir; ValueData: {app}\Samples\
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Globals; ValueType: string; ValueName: TargetLocation; ValueData: $(MSBuildBinPath)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\InstalledUpdates; ValueType: string; ValueName: Main Product Update; ValueData: Delphi XE5 and C++Builder XE5 Update 2
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\InterBase; ValueType: string; ValueName: IBRedist; ValueData: {commondocs}\InterBase\redist\InterBaseXE3
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\androiddebugide190.bpl; ValueData: (Untitled); Components: MOBILE\ANDROID
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\asmview190.bpl; ValueData: Assembly Browser Package
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\codetemplates190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\comcore190.bpl; ValueData: HtmlHelp Viewer
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\bin\comptoolbar190.bpl; ValueData: Component Toolbar Package
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\bin\coreproide190.bpl; ValueData: Core IDE Pro Package
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\DataExplorerIDE190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\dbkdebugide190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\bin\dbkdebugproide190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\delphiosx32190.bpl; ValueData: Delphi OSX32 Platform; Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\delphiwin32190.bpl; ValueData: Delphi Win32 Platform
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\delphiwin64190.bpl; ValueData: Delphi Win64 Platform; Components: PLATFORM\X64
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\dotnetcoreide190.bpl; ValueData: .NET Core IDE Package
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\bin\exceptiondiag190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\bin\fileexplorer190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\fmxmobiledesigner190.bpl; ValueData: (Untitled); Components: FMX and MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\gdbdebugcore190.bpl; ValueData: (Untitled); Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\gdbdebugide190.bpl; ValueData: (Untitled); Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\bin\historyide190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\bin\htmide190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\htmlhelp2190.bpl; ValueData: HtmlHelp Viewer
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\bin\idefilefilters190.bpl; ValueData: IDE File filters
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\iosdebugide190.bpl; ValueData: (Untitled); Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\iteidew32190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\macosxdebugide190.bpl; ValueData: (Untitled); Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\bin\mlcc190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\bin\plugview190.bpl; ValueData: Pluggable Tree View Package
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\profiledeployide190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\profilemgride190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\projecttargets190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\projpageide190.bpl; ValueData: Value Data: Project and template library package
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\bin\refactoride190.bpl; ValueData: Core Refactoring Package
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\sdkmgride190.bpl; ValueData: Embarcadero SDK Manager
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\startpageide190.bpl; ValueData: Start Page IDE Package
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\tgide190.bpl; ValueData: (Untitled); Components: EXPERTS\TOGETHER
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\tlbview190.bpl; ValueData: TypeLibrary Browser Package
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\bin\todoide190.bpl; ValueData: ToDo
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\unittestide190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\vclmenudesigner190.bpl; ValueData: .NET Core IDE Package
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\VisualizationServiceIDE190.bpl; ValueData: Visualization IDE Service Package
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\win64debugide190.bpl; ValueData: (Untitled); Components: PLATFORM\X64
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages\Delphi; ValueType: string; ValueName: $(BDS)\Bin\delphiandroid32190.bpl; ValueData: Delphi Android Platform; Components: MOBILE\ANDROID
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages\Delphi; ValueType: string; ValueName: $(BDS)\Bin\delphicoment190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages\Delphi; ValueType: string; ValueName: $(BDS)\Bin\delphicompro190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages\Delphi; ValueType: string; ValueName: $(BDS)\Bin\delphicoreproide190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages\Delphi; ValueType: string; ValueName: $(BDS)\Bin\delphide190.bpl; ValueData: Delphi Win32 IDE Personality
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages\Delphi; ValueType: string; ValueName: $(BDS)\Bin\delphierrorinsite190.bpl; ValueData: Delphi Error Insite Package
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages\Delphi; ValueType: string; ValueName: $(BDS)\bin\delphifmxide190.bpl; ValueData: Embarcadero FMX Designer IDE Package; Components: FMX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages\Delphi; ValueType: string; ValueName: $(BDS)\Bin\delphifmxmobile190.bpl; ValueData: Delphi OSX32 Platform; Components: FMX and MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages\Delphi; ValueType: string; ValueName: $(BDS)\Bin\delphiios32190.bpl; ValueData: Delphi OSX32 Platform; Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages\Delphi; ValueType: string; ValueName: $(BDS)\Bin\delphipro190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages\Delphi; ValueType: string; ValueName: $(BDS)\Bin\delphivclide190.bpl; ValueData: Delphi VCL Designer IDE Package
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages\Delphi; ValueType: string; ValueName: $(BDS)\Bin\win32debugide190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known IDE Packages\Delphi; ValueType: string; ValueName: $(BDS)\Bin\win32debugproide190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\applet190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\DataExplorerDBXPlugin190.bpl; ValueData: CodeGear DBX Common Driver Components for Win32
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\DataExplorerDBXPluginEnt190.bpl; ValueData: Embarcadero DBX Enterprise Driver Components for Win32
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\DataExplorerDBXPluginInt190.bpl; ValueData: Embarcadero DBX Interbase Driver Components for Win32
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\DataExplorerService190.bpl; ValueData: CodeGear DBX Common Driver Components for Win32
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dcl31w190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dclact190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dclado190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dclbde190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclbindcomp190.bpl; ValueData: Embarcadero Databinding Components
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclbindcompdbx190.bpl; ValueData: Embarcadero DBX Databinding Components
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclBindCompFireDAC190.bpl; ValueData: Embarcadero FireDAC LiveBindings Designer; Components: FDAC
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclbindcompfmx190.bpl; ValueData: Embarcadero Databinding Components; Components: FMX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclbindcompvcl190.bpl; ValueData: Embarcadero Databinding Components
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclCloudService190.bpl; ValueData: Embarcadero Cloud management components
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclDataSnapClient190.bpl; ValueData: Embarcadero DataSnap Client Components for Win32
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclDataSnapConnectors190.bpl; ValueData: Embarcadero DataSnap Connector Components
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclDataSnapFireDAC190.bpl; ValueData: Embarcadero DataSnap FireDAC Components for Win32
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclDataSnapIndy10ServerTransport190.bpl; ValueData: Embarcadero DataSnap Server Transport Components for Win32
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclDataSnapProviderClient190.bpl; ValueData: Embarcadero DataSnap Provider Client Components for Win32
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclDataSnapServer190.bpl; ValueData: Embarcadero DataSnap Server Components for Win32
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dcldb190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dcldbx190.bpl; ValueData: Embarcadero dbExpress Components
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dcldbxcds190.bpl; ValueData: Embarcadero dbExpress SimpleDS Components
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclDBXDrivers190.bpl; ValueData: CodeGear DBX Common Driver Components for Win32
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclDBXDriversEnt190.bpl; ValueData: Embarcadero DBX Enterprise Driver Components for Win32
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclDBXDriversInt190.bpl; ValueData: Embarcadero DBX Interbase Driver Components for Win32
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dclemacsedit190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclFireDAC190.bpl; ValueData: Embarcadero FireDAC Components; Components: FDAC
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclFireDACEnt190.bpl; ValueData: Embarcadero FireDAC Enterprise Components; Components: FDAC
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclFMXFireDAC190.bpl; ValueData: Embarcadero FireDAC Components for FireMonkey; Components: FDAC and FMX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dclfmxhrh190.bpl; ValueData: Embarcadero FMX Components; Components: FMX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dclfmxstd190.bpl; ValueData: Embarcadero FMX Components; Components: FMX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dclFMXtee9190.bpl; ValueData: (Untitled); Components: FMX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclib190.bpl; ValueData: VCL IBX Components for Win32
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dclie190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclIndyCore190.bpl; ValueData: Indy 10 Core Design Time
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclIndyProtocols190.bpl; ValueData: Indy 10 Protocols Design Time
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dclIntraweb_140_190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclIPIndyImpl190.bpl; ValueData: Embarcadero Indy Implementation for Win32
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dclmcn190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclMetropolisUILiveTile190.bpl; ValueData: Embarcadero Metropolis UI Live Tile Standard Components
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dclmid190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dclmlwiz190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dclnet190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dcloffice2k190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dclofficexp190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclRESTComponents190.bpl; ValueData: Embarcadero REST Components
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dclribbon190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dclsmp190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dclsmpedit190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dclsoap190.bpl; ValueData: Embarcadero SOAP Components
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclstd190.bpl; ValueData: Embarcadero Standard Components
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dcltee9190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\dcltouch190.bpl; ValueData: Embarcadero Touch Components
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\dclVclFireDAC190.bpl; ValueData: Embarcadero FireDAC Components; Components: FDAC
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\Bin\MobileWizardExpert190.bpl; ValueData: Embarcadero Mobile Wizard Help; Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\samplevisualizers190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Known Packages; ValueType: string; ValueName: $(BDS)\bin\svnide190.bpl; ValueData: (Untitled)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Android32; ValueType: string; ValueName: Browsing Path; ValueData: "$(BDS)\OCX\Servers;$(BDS)\SOURCE\VCL;$(BDS)\source\rtl\common;$(BDS)\SOURCE\RTL\SYS;$(BDS)\source\rtl\android;$(BDS)\source\ToolsAPI;$(BDS)\SOURCE\IBX;$(BDS)\source\Internet;$(BDS)\SOURCE\PROPERTY EDITORS;$(BDS)\source\soap;$(BDS)\SOURCE\XML;$(BDS)\source\Indy10\Core;$(BDS)\source\Indy10\System;$(BDS)\source\Indy10\Protocols;$(BDS)\source\fmx;$(BDS)\source\databinding\components;$(BDS)\source\databinding\engine;$(BDS)\source\databinding\graph;$(BDS)\source\data;$(BDS)\source\data\ado;$(BDS)\source\data\bde;$(BDS)\source\data\cloud;$(BDS)\source\data\datasnap;$(BDS)\source\data\dbx;$(BDS)\source\data\dsnap;$(BDS)\source\data\Test;$(BDS)\source\data\vclctrls;$(BDS)\source\rtl\posix;$(BDS)\source\rtl\posix\osx;$(BDS)\source\data\datasnap\connectors;$(BDS)\source\data\datasnap\proxygen;$(BDS)\source\DataExplorer;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\Common;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\Common\dunit;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\DelphiExperts\Common;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\DelphiExperts\DUnitProject;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\DelphiExperts\DUnitProject\dunit;$(BDS)\source\DUnit\src;$(BDS)\source\DUnit\tests;$(BDS)\source\Experts;$(BDS)\source\indy\abstraction;$(BDS)\source\indy\implementation;$(BDS)\source\indyimpl;$(BDS)\source\LiveTile;$(BDS)\source\Property Editors\Indy10;$(BDS)\source\soap\wsdlimporter;$(BDS)\source\Visualizers;$(BDS)\source\xtab;$(BDS)\source\DUnit\Contrib\XMLReporting;$(BDS)\source\DUnit\Contrib\XPGen;$(BDS)\source\data\rest;"; Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Android32; ValueType: string; ValueName: Debug DCU Path; ValueData: $(BDSLIB)\$(PLATFORM)\debug; Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Android32; ValueType: string; ValueName: Package DCP Output; ValueData: $(BDSCOMMONDIR)\Dcp\$(Platform)\$(Configuration); Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Android32; ValueType: string; ValueName: Package DPL Output; ValueData: $(BDSCOMMONDIR)\Bpl\$(PLATFORM)\$(Configuration); Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Android32; ValueType: string; ValueName: Package Search Path; ValueData: $(BDSCOMMONDIR)\Bpl\$(PLATFORM)\Release; Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Android32; ValueType: string; ValueName: Search Path; ValueData: $(BDSLIB)\$(PLATFORM)\Release; Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Android32; ValueType: string; ValueName: Translated Debug Library Path; ValueData: $(BDSLIB)\$(Platform)\debug\$(LANGDIR); Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Android32; ValueType: string; ValueName: Translated Library Path; ValueData: $(BDSLIB)\$(Platform)\release\$(LANGDIR); Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Android32; ValueType: string; ValueName: Translated Resource Path; ValueData: $(BDSLIB)\$(Platform)\release\$(LANGDIR); Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\iOSDevice; ValueType: string; ValueName: Browsing Path; ValueData: "$(BDS)\OCX\Servers;$(BDS)\SOURCE\VCL;$(BDS)\source\rtl\common;$(BDS)\SOURCE\RTL\SYS;$(BDS)\source\rtl\ios;$(BDS)\source\rtl\osx;$(BDS)\source\ToolsAPI;$(BDS)\SOURCE\IBX;$(BDS)\source\Internet;$(BDS)\SOURCE\PROPERTY EDITORS;$(BDS)\source\soap;$(BDS)\SOURCE\XML;$(BDS)\source\Indy10\Core;$(BDS)\source\Indy10\System;$(BDS)\source\Indy10\Protocols;$(BDS)\source\fmx;$(BDS)\source\databinding\components;$(BDS)\source\databinding\engine;$(BDS)\source\databinding\graph;$(BDS)\source\data;$(BDS)\source\data\ado;$(BDS)\source\data\bde;$(BDS)\source\data\cloud;$(BDS)\source\data\datasnap;$(BDS)\source\data\dbx;$(BDS)\source\data\dsnap;$(BDS)\source\data\Test;$(BDS)\source\data\vclctrls;$(BDS)\source\rtl\posix;$(BDS)\source\rtl\posix\osx;$(BDS)\source\data\datasnap\connectors;$(BDS)\source\data\datasnap\proxygen;$(BDS)\source\DataExplorer;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\Common;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\Common\dunit;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\DelphiExperts\Common;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\DelphiExperts\DUnitProject;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\DelphiExperts\DUnitProject\dunit;$(BDS)\source\DUnit\src;$(BDS)\source\DUnit\tests;$(BDS)\source\Experts;$(BDS)\source\indy\abstraction;$(BDS)\source\indy\implementation;$(BDS)\source\indyimpl;$(BDS)\source\LiveTile;$(BDS)\source\Property Editors\Indy10;$(BDS)\source\soap\wsdlimporter;$(BDS)\source\Visualizers;$(BDS)\source\xtab;$(BDS)\source\DUnit\Contrib\XMLReporting;$(BDS)\source\DUnit\Contrib\XPGen;$(BDS)\source\data\rest;"; Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\iOSDevice; ValueType: string; ValueName: Debug DCU Path; ValueData: $(BDSLIB)\$(PLATFORM)\debug; Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\iOSDevice; ValueType: string; ValueName: Package DCP Output; ValueData: $(BDSCOMMONDIR)\Dcp\$(Platform)\$(Configuration); Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\iOSDevice; ValueType: string; ValueName: Package DPL Output; ValueData: $(BDSCOMMONDIR)\Bpl\$(PLATFORM)\$(Configuration); Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\iOSDevice; ValueType: string; ValueName: Package Search Path; ValueData: $(BDSCOMMONDIR)\Bpl\$(PLATFORM)\Release; Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\iOSDevice; ValueType: string; ValueName: Search Path; ValueData: $(BDSLIB)\$(PLATFORM)\Release; Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\iOSDevice; ValueType: string; ValueName: Translated Debug Library Path; ValueData: $(BDSLIB)\$(Platform)\debug\$(LANGDIR); Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\iOSDevice; ValueType: string; ValueName: Translated Library Path; ValueData: $(BDSLIB)\$(Platform)\release\$(LANGDIR); Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\iOSDevice; ValueType: string; ValueName: Translated Resource Path; ValueData: $(BDSLIB)\$(Platform)\release\$(LANGDIR); Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\iOSSimulator; ValueType: string; ValueName: Browsing Path; ValueData: "$(BDS)\OCX\Servers;$(BDS)\SOURCE\VCL;$(BDS)\source\rtl\common;$(BDS)\SOURCE\RTL\SYS;$(BDS)\source\rtl\ios;$(BDS)\source\rtl\osx;$(BDS)\source\ToolsAPI;$(BDS)\SOURCE\IBX;$(BDS)\source\Internet;$(BDS)\SOURCE\PROPERTY EDITORS;$(BDS)\source\soap;$(BDS)\SOURCE\XML;$(BDS)\source\Indy10\Core;$(BDS)\source\Indy10\System;$(BDS)\source\Indy10\Protocols;$(BDS)\source\fmx;$(BDS)\source\databinding\components;$(BDS)\source\databinding\engine;$(BDS)\source\databinding\graph;$(BDS)\source\data;$(BDS)\source\data\ado;$(BDS)\source\data\bde;$(BDS)\source\data\cloud;$(BDS)\source\data\datasnap;$(BDS)\source\data\dbx;$(BDS)\source\data\dsnap;$(BDS)\source\data\Test;$(BDS)\source\data\vclctrls;$(BDS)\source\rtl\posix;$(BDS)\source\rtl\posix\osx;$(BDS)\source\data\datasnap\connectors;$(BDS)\source\data\datasnap\proxygen;$(BDS)\source\DataExplorer;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\Common;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\Common\dunit;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\DelphiExperts\Common;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\DelphiExperts\DUnitProject;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\DelphiExperts\DUnitProject\dunit;$(BDS)\source\DUnit\src;$(BDS)\source\DUnit\tests;$(BDS)\source\Experts;$(BDS)\source\indy\abstraction;$(BDS)\source\indy\implementation;$(BDS)\source\indyimpl;$(BDS)\source\LiveTile;$(BDS)\source\Property Editors\Indy10;$(BDS)\source\soap\wsdlimporter;$(BDS)\source\Visualizers;$(BDS)\source\xtab;$(BDS)\source\DUnit\Contrib\XMLReporting;$(BDS)\source\DUnit\Contrib\XPGen;$(BDS)\source\data\rest;"; Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\iOSSimulator; ValueType: string; ValueName: Debug DCU Path; ValueData: $(BDSLIB)\$(PLATFORM)\debug; Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\iOSSimulator; ValueType: string; ValueName: Package DCP Output; ValueData: $(BDSCOMMONDIR)\Dcp\$(Platform)\$(Configuration); Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\iOSSimulator; ValueType: string; ValueName: Package DPL Output; ValueData: $(BDSCOMMONDIR)\Bpl\$(Platform)\$(Configuration); Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\iOSSimulator; ValueType: string; ValueName: Package Search Output; ValueData: $(BDSCOMMONDIR)\Bpl\$(Platform)\$(Configuration); Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\iOSSimulator; ValueType: string; ValueName: Search Path; ValueData: $(BDSLIB)\$(PLATFORM)\Release; Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\iOSSimulator; ValueType: string; ValueName: Translated Debug Library Path; ValueData: $(BDSLIB)\$(Platform)\debug\$(LANGDIR); Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\iOSSimulator; ValueType: string; ValueName: Translated Library Path; ValueData: $(BDSLIB)\$(Platform)\release\$(LANGDIR); Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\iOSSimulator; ValueType: string; ValueName: Translated Resource Path; ValueData: $(BDSLIB)\$(Platform)\release\$(LANGDIR); Components: MOBILE
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\OSX32; ValueType: string; ValueName: Browsing Path; ValueData: "$(BDS)\OCX\Servers;$(BDS)\SOURCE\VCL;$(BDS)\source\rtl\common;$(BDS)\SOURCE\RTL\SYS;$(BDS)\source\rtl\osx;$(BDS)\source\ToolsAPI;$(BDS)\SOURCE\IBX;$(BDS)\source\Internet;$(BDS)\SOURCE\PROPERTY EDITORS;$(BDS)\source\soap;$(BDS)\SOURCE\XML;$(BDS)\source\Indy10\Core;$(BDS)\source\Indy10\System;$(BDS)\source\Indy10\Protocols;$(BDS)\source\fmx;$(BDS)\source\databinding\components;$(BDS)\source\databinding\engine;$(BDS)\source\databinding\graph;$(BDS)\source\data;$(BDS)\source\data\ado;$(BDS)\source\data\bde;$(BDS)\source\data\cloud;$(BDS)\source\data\datasnap;$(BDS)\source\data\dbx;$(BDS)\source\data\dsnap;$(BDS)\source\data\Test;$(BDS)\source\data\vclctrls;$(BDS)\source\rtl\posix;$(BDS)\source\rtl\posix\osx;$(BDS)\source\data\datasnap\connectors;$(BDS)\source\data\datasnap\proxygen;$(BDS)\source\DataExplorer;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\Common;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\Common\dunit;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\DelphiExperts\Common;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\DelphiExperts\DUnitProject;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\DelphiExperts\DUnitProject\dunit;$(BDS)\source\DUnit\src;$(BDS)\source\DUnit\tests;$(BDS)\source\Experts;$(BDS)\source\indy\abstraction;$(BDS)\source\indy\implementation;$(BDS)\source\indyimpl;$(BDS)\source\LiveTile;$(BDS)\source\Property Editors\Indy10;$(BDS)\source\soap\wsdlimporter;$(BDS)\source\Visualizers;$(BDS)\source\xtab;$(BDS)\source\DUnit\Contrib\XMLReporting;$(BDS)\source\DUnit\Contrib\XPGen;$(BDS)\source\data\rest;"; Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\OSX32; ValueType: string; ValueName: Debug DCU Path; ValueData: $(BDSLIB)\$(Platform)\debug; Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\OSX32; ValueType: string; ValueName: HPP Output Directory; ValueData: $(BDSCOMMONDIR)\hpp; Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\OSX32; ValueType: string; ValueName: Language Library Path; ValueData: "$(BDSLIB)\$(Platform)\release\$(LANGDIR);$(BDS)\lib\$(LANGDIR)"; Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\OSX32; ValueType: string; ValueName: Package DCP Output; ValueData: $(BDSCOMMONDIR)\Dcp\$(Platform); Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\OSX32; ValueType: string; ValueName: Package DPL Output; ValueData: $(BDSCOMMONDIR)\Bpl\$(Platform); Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\OSX32; ValueType: string; ValueName: Package Search Path; ValueData: $(BDSCOMMONDIR)\Bpl\$(Platform); Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\OSX32; ValueType: string; ValueName: Search Path; ValueData: "$(BDSLIB)\$(Platform)\release;$(BDSUSERDIR)\Imports;$(BDS)\Imports;$(BDSCOMMONDIR)\Dcp\$(Platform);$(BDS)\include"; Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\OSX32; ValueType: string; ValueName: Translated Debug Library Path; ValueData: $(BDSLIB)\$(Platform)\debug\$(LANGDIR); Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\OSX32; ValueType: string; ValueName: Translated Library Path; ValueData: $(BDSLIB)\$(Platform)\release\$(LANGDIR); Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\OSX32; ValueType: string; ValueName: Translated Resource Path; ValueData: $(BDSLIB)\$(Platform)\release\$(LANGDIR); Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Win32; ValueType: string; ValueName: Browsing Path; ValueData: "$(BDS)\OCX\Servers;$(BDS)\SOURCE\VCL;$(BDS)\source\rtl\common;$(BDS)\SOURCE\RTL\SYS;$(BDS)\source\rtl\win;$(BDS)\source\ToolsAPI;$(BDS)\SOURCE\IBX;$(BDS)\source\Internet;$(BDS)\SOURCE\PROPERTY EDITORS;$(BDS)\source\soap;$(BDS)\SOURCE\XML;$(BDS)\source\Indy10\Core;$(BDS)\source\Indy10\System;$(BDS)\source\Indy10\Protocols;$(BDS)\source\fmx;$(BDS)\source\databinding\components;$(BDS)\source\databinding\engine;$(BDS)\source\databinding\graph;$(BDS)\source\data;$(BDS)\source\data\ado;$(BDS)\source\data\bde;$(BDS)\source\data\cloud;$(BDS)\source\data\datasnap;$(BDS)\source\data\dbx;$(BDS)\source\data\dsnap;$(BDS)\source\data\Test;$(BDS)\source\data\vclctrls;$(BDS)\source\data\datasnap\connectors;$(BDS)\source\data\datasnap\proxygen;$(BDS)\source\DataExplorer;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\Common;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\Common\dunit;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\DelphiExperts\Common;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\DelphiExperts\DUnitProject;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\DelphiExperts\DUnitProject\dunit;$(BDS)\source\DUnit\src;$(BDS)\source\DUnit\tests;$(BDS)\source\Experts;$(BDS)\source\indy\abstraction;$(BDS)\source\indy\implementation;$(BDS)\source\indyimpl;$(BDS)\source\LiveTile;$(BDS)\source\Property Editors\Indy10;$(BDS)\source\soap\wsdlimporter;$(BDS)\source\Visualizers;$(BDS)\source\xtab;$(BDS)\source\DUnit\Contrib\XMLReporting;$(BDS)\source\DUnit\Contrib\XPGen;$(BDS)\source\data\rest;"
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Win32; ValueType: string; ValueName: Debug DCU Path; ValueData: $(BDSLIB)\$(Platform)\debug
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Win32; ValueType: string; ValueName: HPP Output Directory; ValueData: $(BDSCOMMONDIR)\hpp
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Win32; ValueType: string; ValueName: Language Library Path; ValueData: "$(BDSLIB)\$(Platform)\release\$(LANGDIR);$(BDS)\lib\$(LANGDIR)"
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Win32; ValueType: string; ValueName: Package DCP Output; ValueData: $(BDSCOMMONDIR)\Dcp
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Win32; ValueType: string; ValueName: Package DPL Output; ValueData: $(BDSCOMMONDIR)\Bpl
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Win32; ValueType: string; ValueName: Package Search Path; ValueData: $(BDSCOMMONDIR)\Bpl
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Win32; ValueType: string; ValueName: Search Path; ValueData: "$(BDSLIB)\$(Platform)\release;$(BDSUSERDIR)\Imports;$(BDS)\Imports;$(BDSCOMMONDIR)\Dcp;$(BDS)\include"
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Win32; ValueType: string; ValueName: Translated Debug Library Path; ValueData: $(BDSLIB)\$(Platform)\debug\$(LANGDIR)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Win32; ValueType: string; ValueName: Translated Library Path; ValueData: $(BDSLIB)\$(Platform)\release\$(LANGDIR)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Win32; ValueType: string; ValueName: Translated Resource Path; ValueData: $(BDSLIB)\$(Platform)\release\$(LANGDIR)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Win64; ValueType: string; ValueName: Browsing Path; ValueData: "$(BDS)\OCX\Servers;$(BDS)\SOURCE\VCL;$(BDS)\source\rtl\common;$(BDS)\SOURCE\RTL\SYS;$(BDS)\source\rtl\win;$(BDS)\source\ToolsAPI;$(BDS)\SOURCE\IBX;$(BDS)\source\Internet;$(BDS)\SOURCE\PROPERTY EDITORS;$(BDS)\source\soap;$(BDS)\SOURCE\XML;$(BDS)\source\Indy10\Core;$(BDS)\source\Indy10\System;$(BDS)\source\Indy10\Protocols;$(BDS)\source\fmx;$(BDS)\source\databinding\components;$(BDS)\source\databinding\engine;$(BDS)\source\databinding\graph;$(BDS)\source\data;$(BDS)\source\data\ado;$(BDS)\source\data\bde;$(BDS)\source\data\cloud;$(BDS)\source\data\datasnap;$(BDS)\source\data\dbx;$(BDS)\source\data\dsnap;$(BDS)\source\data\Test;$(BDS)\source\data\vclctrls;$(BDS)\source\data\datasnap\connectors;$(BDS)\source\data\datasnap\proxygen;$(BDS)\source\DataExplorer;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\Common;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\Common\dunit;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\DelphiExperts\Common;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\DelphiExperts\DUnitProject;$(BDS)\source\DUnit\Contrib\DUnitWizard\Source\DelphiExperts\DUnitProject\dunit;$(BDS)\source\DUnit\src;$(BDS)\source\DUnit\tests;$(BDS)\source\Experts;$(BDS)\source\indy\abstraction;$(BDS)\source\indy\implementation;$(BDS)\source\indyimpl;$(BDS)\source\LiveTile;$(BDS)\source\Property Editors\Indy10;$(BDS)\source\soap\wsdlimporter;$(BDS)\source\Visualizers;$(BDS)\source\xtab;$(BDS)\source\DUnit\Contrib\XMLReporting;$(BDS)\source\DUnit\Contrib\XPGen;$(TP)\runtime\vcl;$(BDS)\source\data\rest;"; Components: PLATFORM\X64
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Win64; ValueType: string; ValueName: Debug DCU Path; ValueData: $(BDSLIB)\$(Platform)\debug; Components: PLATFORM\X64
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Win64; ValueType: string; ValueName: HPP Output Directory; ValueData: $(BDSCOMMONDIR)\hpp; Components: PLATFORM\X64
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Win64; ValueType: string; ValueName: Language Library Path; ValueData: "$(BDSLIB)\$(Platform)\release\$(LANGDIR);$(BDS)\lib\$(LANGDIR)"; Components: PLATFORM\X64
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Win64; ValueType: string; ValueName: Package DCP Output; ValueData: $(BDSCOMMONDIR)\Dcp\$(Platform); Components: PLATFORM\X64
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Win64; ValueType: string; ValueName: Package DPL Output; ValueData: $(BDSCOMMONDIR)\Bpl\$(Platform); Components: PLATFORM\X64
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Win64; ValueType: string; ValueName: Package Search Path; ValueData: $(BDSCOMMONDIR)\Bpl\$(Platform); Components: PLATFORM\X64
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Win64; ValueType: string; ValueName: Search Path; ValueData: "$(BDSLIB)\$(Platform)\release;$(BDSUSERDIR)\Imports;$(BDS)\Imports;$(BDSCOMMONDIR)\Dcp\$(Platform);$(BDS)\include"; Components: PLATFORM\X64
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Win64; ValueType: string; ValueName: Translated Debug Library Path; ValueData: $(BDSLIB)\$(Platform)\debug\$(LANGDIR); Components: PLATFORM\X64
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Win64; ValueType: string; ValueName: Translated Library Path; ValueData: $(BDSLIB)\$(Platform)\release\$(LANGDIR); Components: PLATFORM\X64
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Library\Win64; ValueType: string; ValueName: Translated Resource Path; ValueData: $(BDSLIB)\$(Platform)\release\$(LANGDIR); Components: PLATFORM\X64
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Maintenance; ValueType: string; ValueName: InstallDir; ValueData: {app}
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Maintenance; ValueType: string; ValueName: OSX32; ValueData: TRUE; Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Maintenance; ValueType: string; ValueName: OSX32; ValueData: FALSE; Components: not PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Maintenance; ValueType: string; ValueName: WIN64; ValueData: TRUE; Components: PLATFORM\X64
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Maintenance; ValueType: string; ValueName: WIN64; ValueData: FALSE; Components: not PLATFORM\X64
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\New Component; ValueType: string; ValueName: PalettePage; ValueData: Samples
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\New Component; ValueType: string; ValueName: UnitDirName; ValueData: $(BDSPROJECTSDIR)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Personalities; ValueType: string; ValueName: ; ValueData: RAD Studio XE5
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Personalities; ValueType: string; ValueName: Delphi.Win32; ValueData: Delphi XE5
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\PlatformSDKs\AndroidSDK{code:GetAdtVersion}_32bit.sdk; ValueType: string; ValueName: JDKJarsignerPath; ValueData: {code:GetJdkDir}\bin\JarSigner.exe; Components: MOBILE\ANDSDK
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\PlatformSDKs\AndroidSDK{code:GetAdtVersion}_32bit.sdk; ValueType: string; ValueName: JDKKeyToolPath; ValueData: {code:GetJdkDir}\bin\KeyTool.exe; Components: MOBILE\ANDSDK
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\PlatformSDKs\AndroidSDK{code:GetAdtVersion}_32bit.sdk; ValueType: string; ValueName: JDKPath; ValueData: {code:GetJdkDir}; Components: MOBILE\ANDSDK
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\PlatformSDKs\AndroidSDK{code:GetAdtVersion}_32bit.sdk; ValueType: string; ValueName: LibraryPath; ValueData: {code:GetNdkDir}\sources\cxx-stl\stlport\libs\armeabi-v7a; Components: MOBILE\ANDSDK
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\PlatformSDKs\AndroidSDK{code:GetAdtVersion}_32bit.sdk; ValueType: string; ValueName: NDKApiPath; ValueData: {code:GetNdkDir}\platforms\android-14; Components: MOBILE\ANDSDK
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\PlatformSDKs\AndroidSDK{code:GetAdtVersion}_32bit.sdk; ValueType: string; ValueName: NDKArmLinuxAndroidFile; ValueData: {code:GetNdkDir}\toolchains\arm-linux-androideabi-4.6\prebuilt\windows\bin\arm-linux-androideabi-ld.exe; Components: MOBILE\ANDSDK
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\PlatformSDKs\AndroidSDK{code:GetAdtVersion}_32bit.sdk; ValueType: string; ValueName: NDKArmLinuxAndroidStripFile; ValueData: {code:GetNdkDir}\toolchains\arm-linux-androideabi-4.6\prebuilt\windows\bin\arm-linux-androideabi-strip.exe; Components: MOBILE\ANDSDK
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\PlatformSDKs\AndroidSDK{code:GetAdtVersion}_32bit.sdk; ValueType: string; ValueName: NDKGdbServerPath; ValueData: {code:GetNdkDir}\prebuilt\android-arm\gdbserver\gdbserver; Components: MOBILE\ANDSDK
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\PlatformSDKs\AndroidSDK{code:GetAdtVersion}_32bit.sdk; ValueType: string; ValueName: PlatformName; ValueData: Android; Components: MOBILE\ANDSDK
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\PlatformSDKs\AndroidSDK{code:GetAdtVersion}_32bit.sdk; ValueType: string; ValueName: SDKAaptPath; ValueData: {code:GetAaptDir}\Aapt.exe; Components: MOBILE\ANDSDK
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\PlatformSDKs\AndroidSDK{code:GetAdtVersion}_32bit.sdk; ValueType: string; ValueName: SDKAdbPath; ValueData: {code:GetAdtDir}\sdk\platform-tools\Adb.exe; Components: MOBILE\ANDSDK
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\PlatformSDKs\AndroidSDK{code:GetAdtVersion}_32bit.sdk; ValueType: string; ValueName: SDKAndroidPath; ValueData: {code:GetAdtDir}\sdk\tools\Android.bat; Components: MOBILE\ANDSDK
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\PlatformSDKs\AndroidSDK{code:GetAdtVersion}_32bit.sdk; ValueType: string; ValueName: SDKApiLevelPath; ValueData: {code:GetApiLevelDir}; Components: MOBILE\ANDSDK
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\PlatformSDKs\AndroidSDK{code:GetAdtVersion}_32bit.sdk; ValueType: string; ValueName: SDKDisplayName; ValueData: Android SDK {code:GetAdtVersion} 32 bit; Components: MOBILE\ANDSDK
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\PlatformSDKs\AndroidSDK{code:GetAdtVersion}_32bit.sdk; ValueType: string; ValueName: SDKName; ValueData: AndroidSDK{code:GetAdtVersion}_32bit.sdk; Components: MOBILE\ANDSDK
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\PlatformSDKs\AndroidSDK{code:GetAdtVersion}_32bit.sdk; ValueType: string; ValueName: SDKZipAlignPath; ValueData: {code:GetAdtDir}\sdk\tools\ZipAlign.exe; Components: MOBILE\ANDSDK
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\PlatformSDKs\AndroidSDK{code:GetAdtVersion}_32bit.sdk; ValueType: string; ValueName: SystemRoot; ValueData: {code:GetAdtDir}\sdk; Components: MOBILE\ANDSDK
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\PlatformSDKs\AndroidSDK{code:GetAdtVersion}_32bit.sdk; ValueType: string; ValueName: Version; ValueData: {code:GetAdtVersion}; Components: MOBILE\ANDSDK
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Provision\iOSDevice-Adhoc; ValueType: string; ValueName: DistributionCertificate; ValueData: iPhone Distribution; Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Provision\iOSDevice-AppStore; ValueType: string; ValueName: DistributionCertificate; ValueData: iPhone Distribution; Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Provision\iOSDevice-Debug; ValueType: string; ValueName: DeveloperIdentity; ValueData: iPhone Developer; Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Provision\OSX32-AppStore; ValueType: string; ValueName: MacDeveloper; ValueData: Mac Developer; Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Provision\OSX32-AppStore; ValueType: string; ValueName: ThirdPartyInstaller; ValueData: 3rd Party Mac Developer Installer; Components: PLATFORM\OSX
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: ActiveX; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Additional; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: BDE; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: C# Projects; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Code Snippets; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: CodeGear Data Provider; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Components; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Copied Palette Items; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Data Access; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Data Components; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Data Controls; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Datasnap Client; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Datasnap Server; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: DB Web; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: dbExpress; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Delphi for .NET Projects | New Files; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Delphi for .NET Projects; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Delphi Projects | Active X; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Delphi Projects | Delphi Files; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Delphi Projects; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Dialogs; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Enterprise Core Objects; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: HTML Elements; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Markup Files; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Other Files; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Palette Hidden Items; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Standard; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: System; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Web Controls; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Win 3.1; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Win32; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Window Forms; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Windows Forms Components; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Windows Forms Data Components; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\ToolForm\Mapping; ValueType: string; ValueName: Windows Forms Dialogs; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Transfer; ValueType: string; ValueName: Order; ValueData: @(IDE, sQualityCentral),@(IDE, sVCLStyleDesigner),@(IDE, sXMLMapper),@(IDE, sFireDACExplorer),@(IDE, sFireDACMonitor)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Transfer; ValueType: string; ValueName: Params; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Transfer\@(IDE, sBitmapStyleDesigner); ValueType: string; ValueName: Params; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Transfer\@(IDE, sBitmapStyleDesigner); ValueType: string; ValueName: Path; ValueData: {app}\Bin\BitmapStyleDesigner.exe
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Transfer\@(IDE, sBitmapStyleDesigner); ValueType: string; ValueName: Title; ValueData: @(IDE, sBitmapStyleDesigner)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Transfer\@(IDE, sBitmapStyleDesigner); ValueType: string; ValueName: WorkingDir; ValueData: {app}\bin
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Transfer\@(IDE, sFireDACExplorer); ValueType: string; ValueName: Params; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Transfer\@(IDE, sFireDACExplorer); ValueType: string; ValueName: Path; ValueData: {app}\Bin\FDExplorer.exe
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Transfer\@(IDE, sFireDACExplorer); ValueType: string; ValueName: Title; ValueData: @(IDE,  sFireDACExplorer)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Transfer\@(IDE, sFireDACExplorer); ValueType: string; ValueName: WorkingDir; ValueData: {app}\Bin
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Transfer\@(IDE, sFireDACMonitor); ValueType: string; ValueName: Params; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Transfer\@(IDE, sFireDACMonitor); ValueType: string; ValueName: Path; ValueData: {app}\Bin\FDMonitor.exe
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Transfer\@(IDE, sFireDACMonitor); ValueType: string; ValueName: Title; ValueData: @(IDE, sFireDACMonitor)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Transfer\@(IDE, sFireDACMonitor); ValueType: string; ValueName: WorkingDir; ValueData: {app}\Bin
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Transfer\@(IDE, sQualityCentral); ValueType: string; ValueName: Params; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Transfer\@(IDE, sQualityCentral); ValueType: string; ValueName: Path; ValueData: {app}\QualityCentral\QCClientDownload.exe
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Transfer\@(IDE, sQualityCentral); ValueType: string; ValueName: Title; ValueData: @(IDE, sQualityCentral)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Transfer\@(IDE, sQualityCentral); ValueType: string; ValueName: WorkingDir; ValueData: {app}\QualityCentral
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Transfer\@(IDE, sXMLMapper); ValueType: string; ValueName: Params; ValueData: 
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Transfer\@(IDE, sXMLMapper); ValueType: string; ValueName: Path; ValueData: {app}\Bin\xmlmapper.exe
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Transfer\@(IDE, sXMLMapper); ValueType: string; ValueName: Title; ValueData: @(IDE, sXMLMapper)
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\12.0\Transfer\@(IDE, sXMLMapper); ValueType: string; ValueName: WorkingDir; ValueData: {app}\Bin
...
Root: HKLM; SubKey: SOFTWARE\Embarcadero\FireDAC; ValueType: string; ValueName: FDHOME; ValueData: $(PUBLICDOCUMENTSDIR)\RAD Studio\FireDAC; Components: FDAC
...
begin
  if SaveAdtDir = '' then
    if not ExpandMaskFileFullName('{app}\PlatformSDKs\adt-bundle-windows-x86-*', SaveAdtDir) then
      SaveAdtDir := ExpandConstant('{app}\PlatformSDKs\adt-bundle-windows-x86-20130522');
  Result := SaveAdtDir;
end;
...
begin
  if SaveAdtVersion = '' then
    if not FindAdtVersion(SaveAdtVersion) then
      SaveAdtVersion := '22.0.1';
  Result := SaveAdtVersion;
end;

////////////////////////////////////////////////////////////////////////////////
//设计：Lsuper 2013.10.06
//功能：获取 ADT\sdk\build-tools\android-4.2.2 目录
//参数：
////////////////////////////////////////////////////////////////////////////////
...
begin
  ...
  begin
    ...
    if not ExpandMaskFileFullName(S + '\sdk\build-tools\android-*', SaveAaptDir) then
      SaveAaptDir := S + '\sdk\build-tools\android-4.2.2';
  end;
  Result := SaveAaptDir;
end;
...
////////////////////////////////////////////////////////////////////////////////
//设计：Lsuper 2013.10.06
//功能：获取 ADT\sdk\platforms\android-17 目录
//参数：
////////////////////////////////////////////////////////////////////////////////
...
begin
  ...
  begin
    ...
    if not ExpandMaskFileFullName(S + '\sdk\platforms\android-*', SaveApiLevelDir) then
      SaveApiLevelDir := S + '\sdk\platforms\android-17';
  end;
...
begin
  if SaveJdkDir = '' then
    ...
    else SaveJdkDir := ExpandConstant('{pf32}\Java\jdk1.7.0_25');
  Result := SaveJdkDir;
end;
...
begin
  ...
  begin
    if not ExpandMaskFileFullName('{src}\jdk-7*-windows-i586.exe', SaveJdkSetupFile) then
      SaveJdkSetupFile := ExpandConstant('{src}\jdk-7u25-windows-i586.exe')
  end;
...
begin
  if SaveNdkDir = '' then
    if not ExpandMaskFileFullName('{app}\PlatformSDKs\android-ndk-*', SaveNdkDir) then
      SaveNdkDir := ExpandConstant('{app}\PlatformSDKs\android-ndk-r8e');
  Result := SaveNdkDir;
end;
...
begin
  ...
  RedistStyleFiles('{commondocs}\RAD Studio\12.0\Styles', '{app}\Redist\styles\Fmx', '*.style');
  RedistStyleFiles('{commondocs}\RAD Studio\12.0\Styles', '{app}\Redist\styles\vcl', '*.vsf');
end;
...
begin
  ...
  RegisterServer('{app}\bin\bordbk190.dll', ARegister);
  RegisterServer('{app}\bin\bordbk190N.dll', ARegister);
...
begin
  ...
  begin
    ...
    Ret := StringChangeEx(S, 'C:\Program Files\Embarcadero\RAD Studio\12.0', T, True);
...
begin
  ...
  F := S + '\RAD Studio\FireDAC\FDConnectionDefs.ini';
  ReplaceAppPathFile(F);
  F := S + '\RAD Studio\dbExpress\12.0\dbxconnections.ini';
  ReplaceAppPathFile(F);
end;
...
begin
  ...
  begin
    Ret := MsgBox('Do you want to remove all Embarcadero RAD Studio XE5 entries from your registry?', mbConfirmation, MB_YESNO or MB_DEFBUTTON2);
    if Ret = IDNO then
      Exit;
  end;
  RegDeleteKeyIncludingSubkeys(HKEY_CURRENT_USER_32, 'SOFTWARE\Embarcadero\BDS\12.0');
  RegDeleteKeyIncludingSubkeys(HKEY_CURRENT_USER_32, 'SOFTWARE\Embarcadero\ETM\19.0');
  RegDeleteKeyIncludingSubkeys(HKEY_LOCAL_MACHINE_32, 'SOFTWARE\Embarcadero\BDS\12.0');
end;
...
begin
  ...
  AddExtractFileComponent('Ext.PAServer.7z', 'EXTRA\PASERVER', 'Platform Assistant');
  AddExtractFileComponent('Ext.Samples.7z', 'EXTRA\SAMPLE', 'Samples');
  AddExtractFileComponent('Ext.Share.7z', 'EXTRA\SHARE', 'Share Files');
  AddExtractFileComponent('Ext.3th.7z', 'EXTRA\3TH', '3th Files');

  AddExtractFileComponent('Ext.HotFix.7z', 'CORE\HOTFIX', 'Hotfix 1-6 Files');
end;
...
begin
  ...
  SetFileComponentState('Ext.PAServer.7z', 'EXTRA\PASERVER', 'Platform Assistant');
  SetFileComponentState('Ext.Samples.7z', 'EXTRA\SAMPLE', 'Samples');
  SetFileComponentState('Ext.Share.7z', 'EXTRA\SHARE', 'Share Files');
  SetFileComponentState('Ext.3th.7z', 'EXTRA\3TH', '3th Files');

  SetFileComponentState('Ext.HotFix.7z', 'CORE\HOTFIX', 'Hotfix 1-6 Files');

  SetFileComponentState('CS5_Express_RS.exe', 'ADDONS\CODESITE', 'CodeSite Express');
  SetFileComponentState('DevJET_DI_Setup_Express.exe', 'ADDONS\DOCINSI', 'Documentation Insight');
  SetFileComponentState('FastReport4VCL.exe', 'ADDONS\FASTREPORT', 'FastReport');
...
begin
  ...
  RegWriteStringValue(HKEY_LOCAL_MACHINE, 'SOFTWARE\Embarcadero\BDS\12.0', 'RegMergeTimeStamp', S);
end;
...
begin
  ...
  begin
    ...
    SetPathEnvironmentVariable('{commondocs}\RAD Studio\12.0\Bpl', False);
  end
  else begin
    if IsTaskSelected('ENVBIN') then
      SetPathEnvironmentVariable('{app}\bin', True);
    if IsTaskSelected('ENVBPL') then
      SetPathEnvironmentVariable('{commondocs}\RAD Studio\12.0\Bpl', True);
  end;
end;

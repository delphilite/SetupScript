;{ *********************************************************************** }
;{                                                                         }
;{   Embarcadero Delphi XE4 Help 安装脚本                                  }
;{                                                                         }
...
#define AppBinVersion   "18.0.4854.59655"
#define AppLiteVersion  "7.1"
#define AppFileNamePrex "Embarcadero.Delphi.XE4.Help"
#define AppNamePrex     "Embarcadero Delphi XE4 Help Lite"

#define AppSetupID      "{4070B808-62F4-41A2-8440-2954B9DA0608}"
#define AppSetupMutex   "{4070D909-98A5-4EE0-8956-C3A78734FA03}"
...
DefaultDirName={reg:HKLM\SOFTWARE\Embarcadero\BDS\11.0,RootDir|{pf32}\Embarcadero\RAD Studio\11.0}
...
UninstallDisplayName=Embarcadero Delphi and C++Builder XE4 Help System
...
Source: Files\Embarcadero\RAD Studio\11.0\Help\Doc\Main\*; DestDir: {app}\Help\Doc; Flags: recursesubdirs ignoreversion createallsubdirs sortfilesbyextension
Source: Files\Embarcadero\RAD Studio\11.0\Help\Doc\Dinkumware\*; DestDir: {app}\Help\Doc\Dinkumware; Flags: recursesubdirs ignoreversion createallsubdirs sortfilesbyextension; Components: COMP\DINKUM
Source: Files\Embarcadero\RAD Studio\11.0\Help\Doc\Indy\*; DestDir: {app}\Help\Doc\Indy; Flags: recursesubdirs ignoreversion createallsubdirs sortfilesbyextension; Components: COMP\INDY
Source: Files\Embarcadero\RAD Studio\11.0\Help\Doc\Intraweb\*; DestDir: {app}\Help\Doc\Intraweb; Flags: recursesubdirs ignoreversion createallsubdirs sortfilesbyextension; Components: COMP\INTRAWEB
Source: Files\Embarcadero\RAD Studio\11.0\Help\Doc\PSDK\*; DestDir: {app}\Help\Doc\PSDK; Flags: recursesubdirs ignoreversion createallsubdirs sortfilesbyextension; Components: PSDK
;Source: Files\Embarcadero\RAD Studio\11.0\Help\Doc\Rave\*; DestDir: {app}\Help\Doc\Rave; Flags: recursesubdirs ignoreversion createallsubdirs sortfilesbyextension; Components: COMP\RAVE
Source: Files\Embarcadero\RAD Studio\11.0\Help\Doc\TeeChart8Standard\*; DestDir: {app}\Help\Doc\TeeChart8Standard; Flags: recursesubdirs ignoreversion createallsubdirs sortfilesbyextension; Components: COMP\TEECHART
Source: Files\Embarcadero\RAD Studio\11.0\Help\Doc\TeeChartStdHelp\*; DestDir: {app}\Help\Doc\TeeChartStdHelp; Flags: recursesubdirs ignoreversion createallsubdirs sortfilesbyextension; Components: COMP\TEECHART
...
[Icons]
Name: {group}\RAD Studio Documentation; Filename: {cf32}\Microsoft Shared\Help 9\dexplore.exe; Parameters: /helpcol ms-help://embarcadero.rs_xe4; Comment: Opens Embarcadero RAD Studio XE4 Documentation
Name: {group}\Uninstall Documentation; Filename: {uninstallexe}; Comment: Uninstall this Embarcadero RAD Studio XE4 Documentation

Name: {userdesktop}\RAD Studio Documentation; Filename: {cf32}\Microsoft Shared\Help 9\dexplore.exe; Parameters: /helpcol ms-help://embarcadero.rs_xe4; Comment: Opens Embarcadero RAD Studio XE4 Documentation; IconFilename: {cf32}\Microsoft Shared\Help 9\dexplore.exe; Tasks: ICON
...
Filename: {app}\Help\Doc\H2Reg.exe; WorkingDir: {app}\Help\Doc; Parameters: "-r cmdfile=""{app}\Help\Doc\h2reg.ini"""; StatusMsg: {cm:StatusInstalling,Embarcadero RAD Studio XE4 Documentation}
Filename: {app}\Help\Doc\H2Reg.exe; WorkingDir: {app}\Help\Doc; Parameters: "-r cmdfile=""{app}\Help\Doc\filters.ini"""; StatusMsg: {cm:StatusInstalling,Embarcadero RAD Studio XE4 Documentation Filters}
...
Filename: {cf32}\Microsoft Shared\Help 9\dexplore.exe; Parameters: /helpcol ms-help://embarcadero.rs_xe4; Flags: postinstall nowait runascurrentuser; Description: {cm:LaunchProgram,RAD Studio Documentation}

[UninstallRun]
Filename: {app}\Help\Doc\H2Reg.exe; WorkingDir: {app}\Help\Doc; Parameters: "-u cmdfile=""{app}\Help\Doc\h2reg.ini"""; StatusMsg: {cm:StatusUninstalling,Embarcadero RAD Studio XE4 Documentation}
Filename: {app}\Help\Doc\H2Reg.exe; WorkingDir: {app}\Help\Doc; Parameters: "-u cmdfile=""{app}\Help\Doc\filters.ini"""; StatusMsg: {cm:StatusUninstalling,Embarcadero RAD Studio XE4 Documentation Filters}
...
[Registry]
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\11.0\InstalledUpdates; ValueType: string; ValueName: Help Update; ValueData: Help Update 1 for Delphi XE4 and C++Builder XE4; Check: IsDelphiInstalled
Root: HKCU; SubKey: SOFTWARE\Embarcadero\BDS\11.0\InstalledUpdates; ValueType: string; ValueName: Help Update; ValueData: Help Update 1 for Delphi XE4 and C++Builder XE4; Check: IsDelphiInstalled and IsDelphiInited
Root: HKLM; SubKey: SOFTWARE\Embarcadero\BDS\11.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\htmlhelp2180.bpl; ValueData: HtmlHelp Viewer; Check: IsDelphiInstalled
Root: HKCU; SubKey: SOFTWARE\Embarcadero\BDS\11.0\Known IDE Packages; ValueType: string; ValueName: $(BDS)\Bin\htmlhelp2180.bpl; ValueData: HtmlHelp Viewer; Check: IsDelphiInstalled and IsDelphiInited
...
var
  BDS: String;
begin
  Result := RegQueryStringValue(HKEY_LOCAL_MACHINE, 'SOFTWARE\Embarcadero\BDS\11.0', 'App', BDS) and FileExists(BDS);
end;
...
begin
  Result := RegKeyExists(HKEY_CURRENT_USER, 'SOFTWARE\Embarcadero\BDS\11.0');
end;
